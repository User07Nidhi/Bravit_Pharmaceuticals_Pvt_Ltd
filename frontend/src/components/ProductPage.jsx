...
const productDetails = {
  ...
  'riprotin': { name: 'Riprotin', description: 'Riprotin is a general protein supplement for daily nutrition.', price: '₹299', image: '/images/riprotin.jpg' },
  ...
  'bravycare6': { name: 'BravyCare-6', description: 'BravyCare-6 hydrates and nourishes the skin, leaving it radiant.', price: '₹75', image: '/images/Bravycare-6.png' },
  ...
  'bravycarehygiene': { name: 'BravyCare Hygiene Kit', description: 'A complete kit for daily health and hygiene needs.', price: '₹500', image: '/images/Bravycare-6.png' },
...
const ProductPage = () => {
  ...
  // Normalize key: remove spaces, dashes, and convert to lowercase
